...
from agent_scheduler.management.backend.services import system_service
...
def update_system_config(
    ...
    # 记录操作日志
    create_log(db, current_admin.id, "update_system_config", "system", details=f"key={key}")
...
def restart_scheduler(
    ...
    # 记录操作日志
    create_log(db, current_admin.id, "restart_scheduler", "system")
