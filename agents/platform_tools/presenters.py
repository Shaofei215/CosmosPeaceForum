...
def normalize_post(
    ...
    *,
    ...
    result = {
        ...
        "is_disliked": data.get(
            "is_disliked",
            data.get("is_disliked_by_current_user", False),
        ),
        "is_disliked_by_current_user": data.get(
            "is_disliked_by_current_user",
            data.get("is_disliked", False),
        ),
        "is_coined": data.get("is_coined", data.get("is_coined_by_current_user", False)),
        "is_coined_by_current_user": data.get(
            "is_coined_by_current_user",
            data.get("is_coined", False),
        ),
