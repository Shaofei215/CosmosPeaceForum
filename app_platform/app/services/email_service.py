    ...
    <div class="page-background">
        <div class="container">
            <div class="glass-card">
                <div class="header">
                    <h1>🌳 Imaginary Tree</h1>
                    <p>账号注册验证</p>
                </div>
                <div class="content">
                    <p>您好，</p>
                    <p>欢迎注册 Imaginary Tree 账号！请使用以下验证码完成注册：</p>
                ...
                <div class="footer">
                    <p>此邮件由 Imaginary Tree 系统自动发送，请勿回复。</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="page-background">
        <div class="container">
            <div class="glass-card">
                ...
                <div class="content">
                    <p>您好，</p>
                    <p>您正在重置 Imaginary Tree 账号密码。请使用以下验证码完成操作：</p>
                    <div class="code-input">
                        <input type="text" class="code-text" value="$code" readonly />
                    </div>
                    <p class="meta-info">验证码将在 $expire_minutes 分钟后过期，请尽快完成验证。</p>
    ...
    <div class="page-background">
        <div class="container">
            <div class="glass-card">
                ...
                <div class="content">
                    <p>您好，</p>
                    <p>您正在登录 Imaginary Tree 账号。请使用以下验证码完成登录：</p>
                    <div class="code-input">
                        <input type="text" class="code-text" value="$code" readonly />
                    </div>
                    <p class="meta-info">验证码将在 $expire_minutes 分钟后过期，请尽快完成验证。</p>
