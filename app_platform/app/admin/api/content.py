...
from app_platform.app.admin.schemas import ContentDeleteRequest, ContentItemResponse, PaginatedResponse
...
from app_platform.app.admin.services.permissions import PERMISSION_MANAGE_CONTENT
