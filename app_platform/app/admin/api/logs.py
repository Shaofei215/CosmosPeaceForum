...
from app_platform.app.admin.services.log_service import list_operation_logs
from app_platform.app.admin.services.permissions import PERMISSION_VIEW_LOGS
...
async def operation_logs(
    ...
    return OperationLogListResponse(items=items, total=total, skip=skip, limit=limit)
