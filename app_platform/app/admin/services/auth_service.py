...
from app_platform.app.admin.schemas import AdminResponse, AdminProfileUpdateRequest
from app_platform.app.admin.services.permissions import ALL_PERMISSIONS, normalize_permissions
from app_platform.app.core.config import get_settings
from app_platform.app.core.security import create_access_token, get_password_hash, verify_password
